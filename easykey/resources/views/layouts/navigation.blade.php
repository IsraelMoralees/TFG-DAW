        ...
        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
          ...
          @auth
            ...
            @if (auth()->user()->isAdmin())
              <x-nav-link :href="route('admin.videojuegos.index')" :active="request()->is('admin/*')">
                {{ __('Panel Admin') }}
              </x-nav-link>
            @endif
          @endauth
      ...
      <div class="hidden sm:flex sm:items-center sm:ml-6">
        ...
        @else
          <x-dropdown align="right" width="48">
            <x-slot name="trigger">
              <button
                class="flex items-center text-sm font-medium text-gray-500 dark:text-gray-200 hover:text-gray-700 dark:hover:text-white focus:outline-none transition">
  ...
  <div :class="{ 'block': open, 'hidden': ! open }" class="hidden sm:hidden">
    <div class="pt-2 pb-3 space-y-1">
      ...
      @auth
        ...
        @if (auth()->user()->isAdmin())
          <x-responsive-nav-link :href="route('admin.videojuegos.index')" :active="request()->is('admin/*')">
            {{ __('Panel Admin') }}
          </x-responsive-nav-link>
        @endif
      @endauth
