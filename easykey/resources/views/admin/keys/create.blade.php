...
<div class="container mx-auto px-4 py-4">
  ...
  <h1 class="text-white text-3xl font-bold mb-6">
    Nueva Key para: {{ $videojuego->titulo }}
  </h1>

  <!-- Formulario con contenedor estilizado -->
  <div class="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl shadow-xl p-6">
    <form action="{{ route('admin.videojuegos.keys.store', $videojuego) }}" method="POST" class="space-y-6">
      @csrf
